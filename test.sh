...
additional_params="--info-level"


# sudo ./yxct install yxct --usr-local-sbin --script-path "${TestPath}/.yxct.setup.py" ${additional_params}
# echo '===================================================================================================='
# sudo which yxct
...
sudo ./yxct install yxct --usr-local-sbin --script-path "${TestPath}/.yxct.setup.sh" ${additional_params}
sudo ./yxct uninstall yxct
echo '===================================================================================================='

echo "如果提供了脚本路径 -> 脚本路径是一个文件 -> 文件不是安装脚本, 但使用了--no-installer参数, 则直接安装文件"
sudo ./yxct install yxct --no-installer --force --usr-local-sbin --script-path "${TestPath}/yxct" ${additional_params}
sudo ./yxct uninstall yxct
echo '===================================================================================================='

echo "如果提供了脚本路径 -> 脚本路径是一个目录 -> 目录中找到安装脚本, 直接掉用那个安装脚本"
sudo ./yxct install yxct --no-installer --force --usr-local-sbin --script-path "${TestPath}" ${additional_params}
sudo ./yxct uninstall yxct
echo '===================================================================================================='
...
sudo ./yxct uninstall yxct --script-path "${TestPath}/.yxct.setup.sh" ${additional_params}
echo '===================================================================================================='

echo "如果提供了脚本路径 -> 如果脚本路径是一个文件 -> 如果文件不上是安装脚本，但指定了--no-installer参数, 尝试查找文件相同的命令, 并删除"
sudo ./yxct install yxct --no-installer --usr-local-sbin --script-path "${TestPath}/yxct"
sudo ./yxct uninstall yxct --no-installer --script-path "${TestPath}/yxct" ${additional_params}
echo '===================================================================================================='

echo "如果提供了脚本路径 -> 如果脚本径是一个目录 -> 如果目录中找到安装脚本, 直接调用那个安装脚本"
sudo ./yxct install yxct --no-installer --usr-local-sbin --script-path "${TestPath}/yxct"
sudo ./yxct uninstall yxct --script-path "${TestPath}" ${additional_params}
echo '===================================================================================================='
